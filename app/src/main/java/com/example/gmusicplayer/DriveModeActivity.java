...
public class DriveModeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        findViewById(R.id.nextButton).setOnClickListener((View.OnClickListener) this);
        findViewById(R.id.prevButton).setOnClickListener((View.OnClickListener) this);
        findViewById(R.id.closeButton).setOnClickListener((View.OnClickListener) this);
    }
